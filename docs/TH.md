...
- รองรับ English/ไทย โดยค่าเริ่มต้นเป็น English และเปลี่ยนภาษาได้ในหน้า setup
...
4. เลือกภาษาได้ถ้าต้องการ ค่าเริ่มต้นคือ English
5. กดตรวจสอบและบันทึก
6. แอปจะโหลดข้อความและเปิด realtime ให้อัตโนมัติ
...
5. กดตรวจสอบและบันทึก
6. อนุญาตอ่าน SMS
7. อนุญาต background sync หรือ battery unrestricted
8. ดูสถานะ keep-alive ให้เป็น `On` หรือ `เปิด` ตามภาษาที่เลือก
